...
public class Controller {
    private AcervoJDBCImpl livros;

    @Autowired
    public Controller(AcervoJDBCImpl livros) {
        this.livros = livros; 
    }
    ...
    public List<Livro> getListaLivros() {
        System.out.println("getListaLivros");
        System.out.println(livros.getAll());
        return livros.getAll();
    }

    @GetMapping("teste")
    public Livro teste(){
        return new Livro (1, "Meu Livro", "João", 2002);
    }
